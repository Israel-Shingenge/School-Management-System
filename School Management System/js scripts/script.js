...
function searchAndEnrollSubject() {
    // Get the search input and result display elements
    const searchInput = document.getElementById('subject-search');
    const searchResult = document.getElementById('search-result');
    const enrolledSubjects = document.getElementById('enrolled-subjects');

    // Trim and convert to title case for consistent matching
...
function searchAndEnrollSubject() {
    ...
    if (availableSubjects.includes(searchTerm)) {
        ...
        if (existingEnrollments.includes(searchTerm)) {
            ...
            li.innerHTML = `
                ${searchTerm} 
                <button onclick="deregisterCourse(this)">Deregister</button>
            `;
...
function deregisterCourse(button) {
    ...
    // Optional: Show a deregistration message
    const searchResult = document.getElementById('search-result');
